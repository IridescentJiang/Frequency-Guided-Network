...
from datasets import cityscapes, kitti, teeth_mask, teeth_no_plaque
...
mean_std = ([0.667, 0.602, 0.530, 0.673], [0.168, 0.197, 0.189, 0.461])
#mean_std = ([0.667, 0.602, 0.530], [0.168, 0.197, 0.189])
...
def setup_loader():
    ...
    if args.dataset == 'cityscapes':
        ...
        if args.inference_mode == 'pooling':
            eval_mode_pooling = True
            eval_scales = args.scales
        test_set = args.dataset_cls.TeethMask(args.mode, args.split,
                                              transform=val_input_transform,
                                              target_transform=target_transform,
        ...
        test_set = args.dataset_cls.KITTI(quality=args.mode, mode=args.split,
                                          transform=val_input_transform,
                                          target_transform=target_transform,
                                          cv_split=args.cv_split)
    else:
