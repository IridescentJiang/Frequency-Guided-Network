...
__C.DATASET.TEETH_DIR = './data/teeth'
__C.DATASET.TEETH_TRANS_DIR = './data/teeth_trans'
__C.DATASET.TEETH_MASK_DIR = './data/teeth_mask'
__C.DATASET.TEETH_NO_PLAQUE_DIR = './data/teeth_no_plaque'
