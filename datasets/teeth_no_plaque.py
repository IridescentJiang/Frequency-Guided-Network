"""
teeth_no_plaque Dataset Loader
"""
import logging
import json
import os
...
import datasets.teeth_no_plaque_labels as teeth_no_plaque_labels
import datasets.edge_utils as edge_utils

from config import cfg

trainid_to_name = teeth_no_plaque_labels.trainId2name
id_to_trainid = teeth_no_plaque_labels.label2trainid
num_classes = 2
ignore_label = 255
root = cfg.DATASET.TEETH_NO_PLAQUE_DIR
...
class CityScapes(data.Dataset):
    ...
    def __init__(self, quality, mode, maxSkip=0, joint_transform=None, sliding_crop=None,
        ...
        self.mean_std = ([0.667, 0.602, 0.530], [0.168, 0.197, 0.189])
